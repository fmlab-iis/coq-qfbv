...
From BBCache Require Import Cache BitBlastingInit BitBlastingCCacheDef
...
Theorem bit_blast_cache_sat_sound :
  forall (e : QFBV.bexp) te m c g cs lr,
    bit_blast_bexp_cache te init_vm init_cache init_gen e = (m, c, g, cs, lr) ->
    QFBV.well_formed_bexp e te ->
...
Proof.
  ...
  move: (bit_blast_bexp_cache_is_bit_blast_bexp_ccache init_compatible Hcache)
        => [cc [Hccache _]].
  exact: (bit_blast_ccache_sat_sound Hccache).
Qed.

Theorem bit_blast_cache_sat_complete :
  forall (e : QFBV.bexp) te m c g cs lr,
    bit_blast_bexp_cache te init_vm init_cache init_gen e = (m, c, g, cs, lr) ->
    QFBV.well_formed_bexp e te ->
    (exists s, AdhereConform.conform_bexp e s te /\
