...
Lemma bit_blast_exp_ccache_interp_cache_ct_nocet_const :
  forall (b : bits) (te : SSATE.env) (m : vm) (c : compcache) 
    ...
    interp_cache_ct E c -> interp_cnf E (add_prelude cs) -> interp_cache_ct E c'.
Proof.
  move=> bs te m c g m' c' g' cs ls E Hfcet. rewrite /= Hfcet.
  case Hfhet : (find_het (QFBV.Econst bs) c) => [[cse lse] | ];
  case=> _ <- _ <- _ HiEc HiEcse;
  rewrite add_prelude_expand in HiEcse; move: HiEcse => /andP [_ HiEcse];
  by apply interp_cache_ct_add_cet.
...
Lemma bit_blast_exp_ccache_interp_cache_ct_nocet_unop :
  forall (op : QFBV.eunop) (e1 : QFBV.exp),
...
Lemma bit_blast_exp_ccache_interp_cache_ct_nocet_ite :
  forall b : QFBV.bexp,
    (forall (te : SSATE.env) (m : vm) (c : compcache) (g : generator) 
            (m' : vm) (c' : compcache) (g' : generator) (cs : cnf) 
            (l : literal) (E : env),
    ...
    forall e1 : QFBV.exp,
      ...
      forall e2 : QFBV.exp,
        ...
        forall (te : SSATE.env) (m : vm) (c : compcache) (g : generator) 
          ...
          interp_cache_ct E c'.
Proof.
  move=> b IHb e1 IH1 e2 IH2 te m c g m' c' g' cs ls E Hfcet. rewrite /= Hfcet.
  ...
  case Hfhet : (find_het (QFBV.Eite b e1 e2) c2) => [[csop lsop] | ];
    ...
    rewrite !add_prelude_catrev => 
             /andP [HiEcsb /andP [HiEcs1 /andP [HiEcs2 HiEcsop]]];
    move: (IHb _ _ _ _ _ _ _ _ _ _ Hb HiEc HiEcsb) => HiEcb;
    move: (IH1 _ _ _ _ _ _ _ _ _ _ He1 HiEcb HiEcs1) => HiEc1;
    move: (IH2 _ _ _ _ _ _ _ _ _ _ He2 HiEc1 HiEcs2) => HiEc2;
    rewrite add_prelude_expand in HiEcsop; move: HiEcsop => /andP [_ HiEcsop];
    by apply interp_cache_ct_add_cet; try rewrite -interp_cache_ct_add_het.
Qed.

Lemma bit_blast_bexp_ccache_interp_cache_ct_nocbt_false :
  forall (te : SSATE.env) (m : vm) (c : compcache) (g : generator) 
         (m' : vm) (c' : compcache) (g' : generator) (cs : cnf) 
         (l : literal) (E : env),
    find_cbt QFBV.Bfalse c = None ->
    ...
    interp_cache_ct E c -> interp_cnf E (add_prelude cs) -> interp_cache_ct E c'.
Proof.
  move=> te m c g m' c' g' cs l E Hfcbt. rewrite /= Hfcbt.
  case Hfhbt : (find_hbt (QFBV.Bfalse) c) => [[cse le] | ];
  case=> _ <- _ <- _ HiEc HiEcse;
  rewrite add_prelude_expand in HiEcse; move: HiEcse => /andP [_ HiEcse];
  by apply interp_cache_ct_add_cbt.
Qed.

Lemma bit_blast_bexp_ccache_interp_cache_ct_nocbt_true :
  forall (te : SSATE.env) (m : vm) (c : compcache) (g : generator) 
         (m' : vm) (c' : compcache) (g' : generator) (cs : cnf) 
         (l : literal) (E : env),
    find_cbt QFBV.Btrue c = None ->
...
Lemma bit_blast_bexp_ccache_interp_cache_ct_nocbt_binop :
  forall (op : QFBV.bbinop) (e1 : QFBV.exp),
    (forall (te : SSATE.env) (m : vm) (c : compcache) (g : generator) 
            (m' : vm) (c' : compcache) (g' : generator) (cs : cnf) 
            (ls : word) (E : env),
    ...
    forall e2 : QFBV.exp,
      ...
      forall (te : SSATE.env) (m : vm) (c : compcache) (g : generator) 
        ...
        interp_cache_ct E c -> interp_cnf E (add_prelude cs) -> interp_cache_ct E c'.
Proof.
  move=> op e1 IH1 e2 IH2 te m c g m' c' g' cs ls E Hfcbt. rewrite /= Hfcbt.
  case He1 : (bit_blast_exp_ccache te m c g e1) => [[[[m1 c1] g1] cs1] ls1].
  case He2 : (bit_blast_exp_ccache te m1 c1 g1 e2) => [[[[m2 c2] g2] cs2] ls2].
  case Hfhbt : (find_hbt (QFBV.Bbinop op e1 e2) c2) => [[csop lop] | ];
...
Lemma bit_blast_bexp_ccache_interp_cache_ct_nocbt_lneg :
  forall e1 : QFBV.bexp,
    (forall (te : SSATE.env) (m : vm) (c : compcache) (g : generator) 
            (m' : vm) (c' : compcache) (g' : generator) (cs : cnf) 
            (l : literal) (E : env),
    ...
    forall (te : SSATE.env) (m : vm) (c : compcache) (g : generator) 
      ...
      interp_cache_ct E c -> interp_cnf E (add_prelude cs) -> interp_cache_ct E c'.
Proof.
  move=> e1 IH1 te m c g m' c' g' cs l E Hfcbt. 
...
Proof.
  ...
  - move: e te m c g m' c' g' cs ls E Hfcet.
    ...
    + exact: bit_blast_exp_ccache_interp_cache_ct_nocet_const.
    + move=> op e1; move: op e1 (IHe e1).
      exact: bit_blast_exp_ccache_interp_cache_ct_nocet_unop.
    + move=> op e1 e2; move: op e1 (IHe e1) e2 (IHe e2).
      exact: bit_blast_exp_ccache_interp_cache_ct_nocet_binop.
    + move=> b e1 e2; move: b (IHb b) e1 (IHe e1) e2 (IHe e2).
      exact: bit_blast_exp_ccache_interp_cache_ct_nocet_ite.
  (* bexp *)
  set IHe := bit_blast_exp_ccache_interp_cache_ct.
  set IHb := bit_blast_bexp_ccache_interp_cache_ct.
  ...
  - move: e te m c g m' c' g' cs l E Hfcbt.
    case.
    + exact: bit_blast_bexp_ccache_interp_cache_ct_nocbt_false.
    + exact: bit_blast_bexp_ccache_interp_cache_ct_nocbt_true.
    + move=> op e1 e2; move: op e1 (IHe e1) e2 (IHe e2).
      exact: bit_blast_bexp_ccache_interp_cache_ct_nocbt_binop.
    + move=> e1; move: e1 (IHb e1).
      exact: bit_blast_bexp_ccache_interp_cache_ct_nocbt_lneg.
    + move=> e1 e2; move: e1 (IHb e1) e2 (IHb e2).
