...
Lemma mk_env_disj_env_equal E1 E2 g l1 l2 E1' E2' g1' g2' cs1 cs2 lr1 lr2 :
  env_equal E1 E2 ->
  mk_env_disj E1 g l1 l2 = (E1', g1', cs1, lr1) ->
  mk_env_disj E2 g l1 l2 = (E2', g2', cs2, lr2) ->
  env_equal E1' E2' /\ g1' = g2' /\ cs1 = cs2 /\ lr1 = lr2.
Proof.
  rewrite /mk_env_disj => Heq. dcase (gen g) => [[g' r'] Hg'].
