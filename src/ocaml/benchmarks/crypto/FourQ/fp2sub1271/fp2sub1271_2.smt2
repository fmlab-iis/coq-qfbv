...
(assert true)
(assert true)
(assert (not (= (bvsmod (bvsub (bvsub (bvadd (bvmul ((_ zero_extend 128) L0x7fffffffdcc0_0) #x000000000000000000000000000000000000000000000001) (bvadd (bvmul ((_ zero_extend 128) L0x7fffffffdcc8_0) #x000000000000000000000000000000010000000000000000) (bvmul ((_ zero_extend 128) #x0000000000000000) #x000000000000000100000000000000000000000000000000))) (bvadd (bvmul ((_ zero_extend 128) L0x7fffffffdce0_0) #x000000000000000000000000000000000000000000000001) (bvadd (bvmul ((_ zero_extend 128) L0x7fffffffdce8_0) #x000000000000000000000000000000010000000000000000) (bvmul ((_ zero_extend 128) #x0000000000000000) #x000000000000000100000000000000000000000000000000)))) (bvadd (bvmul ((_ zero_extend 128) rax_4) #x000000000000000000000000000000000000000000000001) (bvadd (bvmul ((_ zero_extend 128) rax_6) #x000000000000000000000000000000010000000000000000) (bvmul ((_ zero_extend 128) #x0000000000000000) #x000000000000000100000000000000000000000000000000)))) #x00000000000000007FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF) #x000000000000000000000000000000000000000000000000)))
(check-sat)
(exit)
