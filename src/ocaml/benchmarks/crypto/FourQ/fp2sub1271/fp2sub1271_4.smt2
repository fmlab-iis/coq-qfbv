...
(assert true)
(assert true)
(assert (not (bvult (bvadd (bvmul ((_ zero_extend 64) rax_4) #x00000000000000000000000000000001) (bvmul ((_ zero_extend 64) rax_6) #x00000000000000010000000000000000)) #x80000000000000000000000000000000)))
(check-sat)
(exit)
