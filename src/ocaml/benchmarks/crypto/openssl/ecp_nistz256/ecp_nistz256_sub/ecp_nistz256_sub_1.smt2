...
(assert (and (= carry_5 ((_ extract 64 64) (bvsub ((_ zero_extend 1) #x0000000000000000) (bvadd ((_ zero_extend 1) #x0000000000000000) ((_ zero_extend 64) carry_4))))) (= r13_2 ((_ extract 63 0) (bvsub ((_ zero_extend 1) #x0000000000000000) (bvadd ((_ zero_extend 1) #x0000000000000000) ((_ zero_extend 64) carry_4)))))))
(assert (and (= carry_6 ((_ extract 64 64) (bvadd ((_ zero_extend 1) r8_2) ((_ zero_extend 1) #xFFFFFFFFFFFFFFFF)))) (= r8_3 ((_ extract 63 0) (bvadd ((_ zero_extend 1) r8_2) ((_ zero_extend 1) #xFFFFFFFFFFFFFFFF))))))
(assert (and (= carry_7 ((_ extract 64 64) (bvadd (bvadd ((_ zero_extend 1) r9_2) ((_ zero_extend 1) #x00000000FFFFFFFF)) ((_ zero_extend 64) carry_6)))) (= r9_3 ((_ extract 63 0) (bvadd (bvadd ((_ zero_extend 1) r9_2) ((_ zero_extend 1) #x00000000FFFFFFFF)) ((_ zero_extend 64) carry_6))))))
(assert (and (= carry_8 ((_ extract 64 64) (bvadd (bvadd ((_ zero_extend 1) r10_2) ((_ zero_extend 1) #x0000000000000000)) ((_ zero_extend 64) carry_7)))) (= r10_3 ((_ extract 63 0) (bvadd (bvadd ((_ zero_extend 1) r10_2) ((_ zero_extend 1) #x0000000000000000)) ((_ zero_extend 64) carry_7))))))
(assert (and (= carry_9 ((_ extract 64 64) (bvadd (bvadd ((_ zero_extend 1) r11_2) ((_ zero_extend 1) #xFFFFFFFF00000001)) ((_ zero_extend 64) carry_8)))) (= r11_3 ((_ extract 63 0) (bvadd (bvadd ((_ zero_extend 1) r11_2) ((_ zero_extend 1) #xFFFFFFFF00000001)) ((_ zero_extend 64) carry_8))))))
...
(assert (= r8_4 (ite (= zero_1 #b1) r8_2 r8_3)))
(assert (= r9_4 (ite (= zero_1 #b1) r9_2 r9_3)))
(assert (= r10_4 (ite (= zero_1 #b1) r10_2 r10_3)))
(assert (= r11_4 (ite (= zero_1 #b1) r11_2 r11_3)))
