...
(assert (= r13_2 (bvadd (bvadd b5_0 a5_0) ((_ zero_extend 63) carry_5))))
(assert true)
(assert (and (= carry_6 ((_ extract 64 64) (bvsub ((_ zero_extend 1) r8_2) ((_ zero_extend 1) #x004E000000000013)))) (= rax_2 ((_ extract 63 0) (bvsub ((_ zero_extend 1) r8_2) ((_ zero_extend 1) #x004E000000000013))))))
(assert (and (= carry_7 ((_ extract 64 64) (bvsub ((_ zero_extend 1) r9_2) (bvadd ((_ zero_extend 1) #x09480097801382BE) ((_ zero_extend 64) carry_6))))) (= rcx_2 ((_ extract 63 0) (bvsub ((_ zero_extend 1) r9_2) (bvadd ((_ zero_extend 1) #x09480097801382BE) ((_ zero_extend 64) carry_6)))))))
(assert (and (= carry_8 ((_ extract 64 64) (bvsub ((_ zero_extend 1) r10_2) (bvadd ((_ zero_extend 1) #xA6E58DBE43002A06) ((_ zero_extend 64) carry_7))))) (= rdx_2 ((_ extract 63 0) (bvsub ((_ zero_extend 1) r10_2) (bvadd ((_ zero_extend 1) #xA6E58DBE43002A06) ((_ zero_extend 64) carry_7)))))))
(assert (and (= carry_9 ((_ extract 64 64) (bvsub ((_ zero_extend 1) r11_2) (bvadd ((_ zero_extend 1) #x6F82CEFBE47879BB) ((_ zero_extend 64) carry_8))))) (= rsi_2 ((_ extract 63 0) (bvsub ((_ zero_extend 1) r11_2) (bvadd ((_ zero_extend 1) #x6F82CEFBE47879BB) ((_ zero_extend 64) carry_8)))))))
(assert (and (= carry_10 ((_ extract 64 64) (bvsub ((_ zero_extend 1) r12_2) (bvadd ((_ zero_extend 1) #x2D996CC179C6D166) ((_ zero_extend 64) carry_9))))) (= rbx_2 ((_ extract 63 0) (bvsub ((_ zero_extend 1) r12_2) (bvadd ((_ zero_extend 1) #x2D996CC179C6D166) ((_ zero_extend 64) carry_9)))))))
(assert (and (= carry_11 ((_ extract 64 64) (bvsub ((_ zero_extend 1) r13_2) (bvadd ((_ zero_extend 1) #x24009015183F9489) ((_ zero_extend 64) carry_10))))) (= rbp_2 ((_ extract 63 0) (bvsub ((_ zero_extend 1) r13_2) (bvadd ((_ zero_extend 1) #x24009015183F9489) ((_ zero_extend 64) carry_10)))))))
