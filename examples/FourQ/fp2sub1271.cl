  ...
  and [
    smod
	  (
        (
          sub
          (limbs 64 [L0x7fffffffdcc0, L0x7fffffffdcc8, 0@64])
          (limbs 64 [L0x7fffffffdce0, L0x7fffffffdce8, 0@64])
        )
        -
        (limbs 64 [L0x7fffffffdd00, L0x7fffffffdd08, 0@64])
      )
      (((2**127 ) - 1)@192) = 0@192,
    smod
      (
        (
          sub
          (limbs 64 [L0x7fffffffdcd0, L0x7fffffffdcd8, 0@64])
          (limbs 64 [L0x7fffffffdcf0, L0x7fffffffdcf8, 0@64])
		)
		-
        (limbs 64 [L0x7fffffffdd10, L0x7fffffffdd18, 0@64])
      )
      (((2**127 ) - 1)@192) = 0@192,
